...
class FileWrap {
    ...
    public FileWrap() {
		value = new File("c:\\"); // alap esetben
    }

    public FileWrap(String path) {
		value = new File(path); // teljes útvonal kell!
    }
    ...
    public FileWrap(String parent, String child) {
    	value = new File(parent, child);
    }
    ...
    // A következõ függvények mind delegálást segítik elõ
